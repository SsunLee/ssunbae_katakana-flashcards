...
import { EmptyDeckMessage } from "./components/EmptyDeckMessage"; // 👈 1. 새로 만든 컴포넌트 import
import { SingleCardView } from "./components/SingleCardView";   // 👈 1. 새로 만든 컴포넌트 import
...
import { fetchGeneratedWords } from "./services/wordService";
