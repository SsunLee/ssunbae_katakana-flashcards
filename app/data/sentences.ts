...
export const SENTENCES: Sentence[] = [
  ...
  },
  {
    ...
    id: 31,
    sentence: "少し安くなりますか。",
    reading: [{ text: "少", furigana: "すこ" }, "し", { text: "安", furigana: "やす" }, "く なりますか。"],
    furigana: "すこし やすく なりますか。",
    romaji: "sukoshi yasuku narimasu ka.",
    translation: "조금 깎아줄 수 있나요?",
    kanjiDetails: [
      { kanji: "少", meaning: "적다/조금 (すこし)", usages: ["양", "완곡한 부탁"] },
      { kanji: "安", meaning: "싸다/값이 낮다 (やすい)", usages: ["가격 흥정"] },
    ],
  },
  {
    id: 32,
    sentence: "おすすめは何ですか。",
    reading: ["おすすめは ", { text: "何", furigana: "なん" }, "ですか。"],
    furigana: "おすすめは なんですか。",
    romaji: "osusume wa nan desu ka.",
    translation: "추천은 무엇인가요?",
    kanjiDetails: [{ kanji: "何", meaning: "무엇 (なに/なん)", usages: ["질문사", "가게/메뉴"] }],
  },
  {
    id: 33,
    sentence: "店内でお召し上がりですか。",
    reading: [{ text: "店内", furigana: "てんない" }, "で お", { text: "召", furigana: "め" }, "し", { text: "上", furigana: "あ" }, "がりですか。"],
    furigana: "てんないで おめしあがりですか。",
    romaji: "tennai de o-meshiagari desu ka.",
    translation: "매장에서 드시나요?",
    kanjiDetails: [
      { kanji: "店内", meaning: "매장 안 (てんない)", usages: ["식당", "카페"] },
      { kanji: "召上", meaning: "드시다(존경) (めしあがる)", usages: ["정중 표현", "음식"] },
    ],
  },
  {
    id: 34,
    sentence: "お持ち帰りですか。",
    reading: ["お", { text: "持", furigana: "も" }, "ち", { text: "帰", furigana: "かえ" }, "りですか。"],
    furigana: "おもちかえりですか。",
    romaji: "omochikaeri desu ka.",
    translation: "포장하시나요?",
    kanjiDetails: [
      { kanji: "持", meaning: "가지다 (もつ)", usages: ["소지/테이크아웨이"] },
      { kanji: "帰", meaning: "돌아가다 (かえる)", usages: ["귀가/가져감"] },
    ],
  },
  {
    id: 35,
    sentence: "水をもう一杯ください。",
    reading: [{ text: "水", furigana: "みず" }, "を もう", { text: "一杯", furigana: "いっぱい" }, "ください。"],
    furigana: "みずを もう いっぱい ください。",
    romaji: "mizu o mō ippai kudasai.",
    translation: "물 한 잔 더 주세요.",
    kanjiDetails: [
      { kanji: "水", meaning: "물 (みず)", usages: ["음료", "요청"] },
      { kanji: "一杯", meaning: "한 잔 (いっぱい)", usages: ["수량", "주문"] },
    ],
  },
  {
    id: 36,
    sentence: "店員さん、すみません。",
    reading: [{ text: "店員", furigana: "てんいん" }, "さん、すみません。"],
    furigana: "てんいんさん、すみません。",
    romaji: "ten'in-san, sumimasen.",
    translation: "직원분, 죄송합니다(호출).",
    kanjiDetails: [{ kanji: "店員", meaning: "점원 (てんいん)", usages: ["호출", "가게"] }],
  },
  {
    id: 37,
    sentence: "大丈夫です、見ているだけです。",
    reading: [{ text: "大丈", furigana: "だいじょう" }, "ぶです、", { text: "見", furigana: "み" }, "ているだけです。"],
    furigana: "だいじょうぶです、みているだけです。",
    romaji: "daijōbu desu, miteiru dake desu.",
    translation: "괜찮아요, 그냥 보고 있어요.",
    kanjiDetails: [
      { kanji: "大丈", meaning: "괜찮다 (だいじょうぶ)", usages: ["사양/완곡 거절"] },
      { kanji: "見", meaning: "보다 (みる)", usages: ["쇼핑", "행동"] },
    ],
  },
  {
    id: 38,
    sentence: "カードで払えますか。",
    reading: ["カードで ", { text: "払", furigana: "はら" }, "えますか。"],
    furigana: "カードで はらえますか。",
    romaji: "kādo de haraemasu ka.",
    translation: "카드로 결제할 수 있나요?",
    kanjiDetails: [{ kanji: "払", meaning: "지불하다 (はらう)", usages: ["결제 수단"] }],
  },
  {
    id: 39,
    sentence: "レシートをください。",
  ...
  },
  {
    id: 40,
    sentence: "席は空いていますか。",
    reading: [{ text: "席", furigana: "せき" }, "は ", { text: "空", furigana: "あ" }, "いていますか。"],
    furigana: "せきは あいていますか。",
    romaji: "seki wa aite imasu ka.",
    translation: "자리 비어 있나요?",
    kanjiDetails: [
      { kanji: "席", meaning: "좌석 (せき)", usages: ["식당/교통"] },
      { kanji: "空", meaning: "비다 (あく/あいている)", usages: ["가용성"] },
    ],
  },
  {
    id: 41,
    sentence: "予約はしていません。",
    reading: [{ text: "予約", furigana: "よやく" }, "は していません。"],
    furigana: "よやくは していません。",
    romaji: "yoyaku wa shite imasen.",
    translation: "예약은 안 했습니다.",
    kanjiDetails: [{ kanji: "予約", meaning: "예약 (よやく)", usages: ["식당/미용실/병원"] }],
  },
  {
    id: 42,
    sentence: "写真を見せていただけますか。",
    reading: [{ text: "写真", furigana: "しゃしん" }, "を ", { text: "見", furigana: "み" }, "せて いただけますか。"],
    furigana: "しゃしんを みせて いただけますか。",
    romaji: "shashin o misete itadakemasu ka.",
    translation: "사진 좀 보여주실 수 있나요?",
    kanjiDetails: [
      { kanji: "写真", meaning: "사진 (しゃしん)", usages: ["제품/메뉴 확인"] },
      { kanji: "見", meaning: "보다/보여주다 (みる/みせる)", usages: ["정중 요청"] },
    ],
  },
  {
    id: 43,
    sentence: "道を教えてください。",
    reading: [{ text: "道", furigana: "みち" }, "を ", { text: "教", furigana: "おし" }, "えてください。"],
    furigana: "みちを おしえて ください。",
    romaji: "michi o oshiete kudasai.",
    translation: "길 좀 알려주세요.",
    kanjiDetails: [
      { kanji: "道", meaning: "길 (みち)", usages: ["길 안내"] },
      { kanji: "教", meaning: "가르치다 (おしえる)", usages: ["정보 제공 요청"] },
    ],
  },
  {
    id: 44,
    sentence: "写真を撮ってもらってもいいですか。",
    reading: [{ text: "写真", furigana: "しゃしん" }, "を ", { text: "撮", furigana: "と" }, "って もらっても いいですか。"],
    furigana: "しゃしんを とって もらっても いいですか。",
    romaji: "shashin o totte moratte mo ii desu ka.",
    translation: "사진 좀 찍어 주시겠어요?",
    kanjiDetails: [
      { kanji: "写真", meaning: "사진", usages: ["관광", "부탁"] },
      { kanji: "撮", meaning: "찍다 (とる)", usages: ["행동"] },
    ],
  },
  {
    id: 45,
    sentence: "Wi-Fiのパスワードは何ですか。",
    reading: ["Wi-Fiの パスワードは ", { text: "何", furigana: "なん" }, "ですか。"],
    furigana: "ワイファイの パスワードは なんですか。",
    romaji: "waifai no pasuwādo wa nan desu ka.",
    translation: "와이파이 비밀번호가 무엇인가요?",
    kanjiDetails: [{ kanji: "何", meaning: "무엇 (なに/なん)", usages: ["정보 질문"] }],
  },
  {
    id: 46,
    sentence: "辛くしないでください。",
    reading: [{ text: "辛", furigana: "から" }, "く しないで ください。"],
    furigana: "からく しないで ください。",
    romaji: "karaku shinaide kudasai.",
    translation: "맵지 않게 해 주세요.",
    kanjiDetails: [{ kanji: "辛", meaning: "맵다 (からい)", usages: ["음식 주문", "요청"] }],
  },
  {
    id: 47,
    sentence: "おすすめの店はありますか。",
    reading: ["おすすめの ", { text: "店", furigana: "みせ" }, "は ありますか。"],
    furigana: "おすすめの みせは ありますか。",
    romaji: "osusume no mise wa arimasu ka.",
    translation: "추천하는 가게가 있나요?",
    kanjiDetails: [{ kanji: "店", meaning: "가게 (みせ)", usages: ["여행/현지 정보"] }],
  },
  {
    id: 48,
    sentence: "ここで写真を撮ってもいいですか。",
    reading: ["ここで ", { text: "写真", furigana: "しゃしん" }, "を ", { text: "撮", furigana: "と" }, "っても いいですか。"],
    furigana: "ここで しゃしんを とっても いいですか。",
    romaji: "koko de shashin o totte mo ii desu ka.",
    translation: "여기서 사진 찍어도 되나요?",
    kanjiDetails: [
      { kanji: "写真", meaning: "사진", usages: ["촬영 허가"] },
      { kanji: "撮", meaning: "찍다 (とる)", usages: ["행동"] },
    ],
  },
  {
    id: 49,
    sentence: "道が混んでいます。",
    reading: [{ text: "道", furigana: "みち" }, "が ", { text: "混", furigana: "こ" }, "んでいます。"],
    furigana: "みちが こんでいます。",
    romaji: "michi ga konde imasu.",
    translation: "길이 막혀요.",
    kanjiDetails: [
      { kanji: "道", meaning: "길 (みち)", usages: ["교통 상황"] },
      { kanji: "混", meaning: "붐비다 (こむ)", usages: ["혼잡"] },
    ],
  },
  {
    id: 50,
    sentence: "時間はどのくらいかかりますか。",
    reading: [{ text: "時間", furigana: "じかん" }, "は どのくらい かかりますか。"],
    furigana: "じかんは どのくらい かかりますか。",
    romaji: "jikan wa dono kurai kakarimasu ka.",
    translation: "시간은 어느 정도 걸리나요?",
    kanjiDetails: [{ kanji: "時間", meaning: "시간 (じかん)", usages: ["소요시간 질문"] }],
  },
  {
    id: 51,
    sentence: "英語のメニューはありますか。",
    reading: [{ text: "英語", furigana: "えいご" }, "の メニューは ありますか。"],
    furigana: "えいごの メニューは ありますか。",
    romaji: "eigo no menyū wa arimasu ka.",
    translation: "영어 메뉴판 있나요?",
    kanjiDetails: [{ kanji: "英語", meaning: "영어 (えいご)", usages: ["언어", "메뉴 요청"] }],
  },
  {
    id: 52,
    sentence: "写真のように作ってください。",
    reading: [{ text: "写真", furigana: "しゃしん" }, "の ように ", { text: "作", furigana: "つく" }, "ってください。"],
    furigana: "しゃしんの ように つくって ください。",
    romaji: "shashin no yō ni tsukutte kudasai.",
    translation: "사진처럼 만들어 주세요.",
    kanjiDetails: [
      { kanji: "写真", meaning: "사진", usages: ["요청 기준"] },
      { kanji: "作", meaning: "만들다 (つくる)", usages: ["조리/제작"] },
    ],
  },
  {
    id: 53,
    sentence: "辛さは控えめでお願いします。",
    reading: [{ text: "辛", furigana: "から" }, "さは ", { text: "控", furigana: "ひか" }, "えめで おねがいします。"],
    furigana: "からさは ひかえめで おねがいします。",
    romaji: "karasa wa hikaeme de onegai shimasu.",
    translation: "매운맛은 약하게 부탁해요.",
    kanjiDetails: [
      { kanji: "辛", meaning: "맵다 (からい)", usages: ["맛 세기"] },
      { kanji: "控", meaning: "절제/줄이다 (ひかえる)", usages: ["강도 조절"] },
    ],
  },
  {
    id: 54,
    sentence: "砂糖は入れないでください。",
    reading: [{ text: "砂糖", furigana: "さとう" }, "は ", { text: "入", furigana: "い" }, "れないで ください。"],
    furigana: "さとうは いれないで ください。",
    romaji: "satō wa irenaide kudasai.",
    translation: "설탕은 넣지 말아 주세요.",
    kanjiDetails: [
      { kanji: "砂糖", meaning: "설탕 (さとう)", usages: ["음료 커스터마이즈"] },
      { kanji: "入", meaning: "넣다 (いれる)", usages: ["조리/추가"] },
    ],
  },
  {
    id: 55,
    sentence: "別々でお願いします。",
    reading: [{ text: "別々", furigana: "べつべつ" }, "で おねがいします。"],
    furigana: "べつべつで おねがいします。",
    romaji: "betsubetsu de onegai shimasu.",
    translation: "계산은 따로 해 주세요.",
    kanjiDetails: [{ kanji: "別々", meaning: "따로따로 (べつべつ)", usages: ["결제 방식"] }],
  },
  {
    id: 56,
    sentence: "一緒で大丈夫です。",
    reading: [{ text: "一緒", furigana: "いっしょ" }, "で ", { text: "大丈", furigana: "だいじょう" }, "ぶです。"],
    furigana: "いっしょで だいじょうぶです。",
    romaji: "issho de daijōbu desu.",
    translation: "같이 계산해도 괜찮아요.",
    kanjiDetails: [
      { kanji: "一緒", meaning: "함께 (いっしょ)", usages: ["묶음 결제"] },
      { kanji: "大丈", meaning: "괜찮다 (だいじょうぶ)", usages: ["허용/수락"] },
    ],
  },
  {
    id: 57,
    sentence: "領収書をお願いします。",
    reading: [{ text: "領収書", furigana: "りょうしゅうしょ" }, "を おねがいします。"],
    furigana: "りょうしゅうしょを おねがいします。",
    romaji: "ryōshūsho o onegai shimasu.",
    translation: "영수증(공식) 부탁드립니다.",
    kanjiDetails: [{ kanji: "領収書", meaning: "영수증 (りょうしゅうしょ)", usages: ["회사/정산"] }],
  },
  {
    id: 58,
    sentence: "大盛りにできますか。",
    reading: [{ text: "大盛", furigana: "おおも" }, "りに できますか。"],
    furigana: "おおもりに できますか。",
    romaji: "ōmori ni dekimasu ka.",
    translation: "곱빼기로 할 수 있나요?",
    kanjiDetails: [{ kanji: "大盛", meaning: "곱빼기 (おおもり)", usages: ["양 조절"] }],
  },
  {
    id: 59,
    sentence: "少なめでお願いします。",
    reading: [{ text: "少", furigana: "すく" }, "なめで おねがいします。"],
    furigana: "すくなめで おねがいします。",
    romaji: "sukuname de onegai shimasu.",
    translation: "적게 부탁합니다.",
    kanjiDetails: [{ kanji: "少", meaning: "적다 (すくない)", usages: ["양 조절"] }],
  },
  {
    id: 60,
    sentence: "これを温めてもらえますか。",
    reading: ["これを ", { text: "温", furigana: "あたた" }, "めて もらえますか。"],
    furigana: "これを あたためて もらえますか。",
    romaji: "kore o atatamete moraemasu ka.",
    translation: "이거 데워 주실 수 있나요?",
    kanjiDetails: [{ kanji: "温", meaning: "따뜻하게 하다 (あたためる)", usages: ["편의점/식당"] }],
  },
  {
    id: 61,
    sentence: "袋はいりますか。",
    reading: [{ text: "袋", furigana: "ふくろ" }, "は いりますか。"],
    furigana: "ふくろは いりますか。",
    romaji: "fukuro wa irimasu ka.",
    translation: "봉투 필요하세요?",
    kanjiDetails: [{ kanji: "袋", meaning: "봉투/쇼핑백 (ふくろ)", usages: ["카운터 질문"] }],
  },
  {
    id: 62,
    sentence: "ここは撮影禁止です。",
    reading: ["ここは ", { text: "撮影", furigana: "さつえい" }, { text: "禁", furigana: "きん" }, "しです。"],
    furigana: "ここは さつえい きんしです。",
    romaji: "koko wa satsuei kinshi desu.",
    translation: "여기는 촬영 금지입니다.",
    kanjiDetails: [
      { kanji: "撮影", meaning: "촬영 (さつえい)", usages: ["규칙 안내"] },
      { kanji: "禁", meaning: "금지 (きんし)", usages: ["주의 표기"] },
    ],
  },
  {
    id: 63,
    sentence: "並んでもいいですか。",
    reading: [{ text: "並", furigana: "なら" }, "んでも いいですか。"],
    furigana: "ならんでも いいですか。",
    romaji: "narande mo ii desu ka.",
    translation: "줄을 서도 되나요?",
    kanjiDetails: [{ kanji: "並", meaning: "줄 서다/늘어서다 (ならぶ)", usages: ["매장/이벤트"] }],
  }
];
